...
public class GreedyStrat implements Strategy {
	 ...
	 * 
	 * STRATEGY:
	 * Gives higher score if Musketeers have more moves, or are not in the same row or column.
	 * Gives a lower score if the Musketeers have few moves, or are in the same row or column.
